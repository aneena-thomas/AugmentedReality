...
open class ARTrackingManager: NSObject, CLLocationManagerDelegate
{
     ...
     */
    @objc open var altitudeSensitive = false
    ...
    //===== Internal variables
    @objc fileprivate(set) internal var locationManager: CLLocationManager = CLLocationManager()
    @objc fileprivate(set) internal var tracking = false
    @objc fileprivate(set) internal var userLocation: CLLocation?
    @objc fileprivate(set) internal var heading: Double = 0
    @objc internal weak var delegate: ARTrackingManagerDelegate?
    @objc internal var orientation: CLDeviceOrientation = CLDeviceOrientation.portrait
        {
        didSet
        {
    ...
    @objc internal var pitch: Double
        {
        get
        {
     ...
     */
    @objc internal func startTracking(notifyLocationFailure: Bool = false)
    {
    ...
    @objc internal func stopTracking()
    {
  ...
  @objc internal func reportLocationToDelegate()
    ...
    // MARK:                                                        Calculations
    //==========================================================================================================================================================
    @objc internal func calculatePitch() -> Double
    {
    ...
    @objc internal func azimuthFromUserToLocation(_ location: CLLocation) -> Double
    {
    ...
    @objc internal func startDebugMode(_ location: CLLocation)
    {
        self.debugLocation = location
        self.userLocation = location;
    }
    @objc internal func stopDebugMode(_ location: CLLocation)
    {
    ...
    @objc func startLocationSearchTimer(resetStartTime: Bool = true)
    {
        self.stopLocationSearchTimer()
    ...
    @objc func stopLocationSearchTimer(resetStartTime: Bool = true)
    {
